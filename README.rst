...
.. image:: https://secure.travis-ci.org/noirbizarre/flask-restplus.png
    ...
    :alt: Build status
.. image:: https://coveralls.io/repos/noirbizarre/flask-restplus/badge.png?branch=0.2.3
    :target: https://coveralls.io/r/noirbizarre/flask-restplus?branch=0.2.3
    :alt: Code coverage
.. image:: https://requires.io/github/noirbizarre/flask-restplus/requirements.png?tag=0.2.3
    :target: https://requires.io/github/noirbizarre/flask-restplus/requirements/?tag=0.2.3
    :alt: Requirements Status
.. image:: https://readthedocs.org/projects/flask-restplus/badge/?version=0.2.3
    :target: http://flask-restplus.readthedocs.org/en/0.2.3/
